...
class Tree(Plant):
    def __init__(self, *,
                 emoji: str = '🌳',
                 product: Product,
                 water_needs: confloat(gt=5),
                 growth_rate: confloat(gt=0, le=5.5),
...
class Pine(Tree):
    def __init__(self, *, growth: float = 0, fertilizer_quantity: float = 0):
        super().__init__(
            emoji='🌲',
            product=Product.PINE_WOOD,
            water_needs=5.5,
            growth_rate=1.8,
            size=9,
            fertilizer_limit=1.125,
            growth=growth, fertilizer_quantity=fertilizer_quantity
        )
...
class Maple(Tree):
    def __init__(self, *, growth: float = 0, fertilizer_quantity: float = 0):
        super().__init__(
            emoji='🍁',
            product=Product.MAPLE_SYRUP,
            water_needs=7.0,
            growth_rate=2.5,
            size=8,
            fertilizer_limit=1.35,
            growth=growth, fertilizer_quantity=fertilizer_quantity
        )
...
class Willow(Tree):
    def __init__(self, *, growth: float = 0, fertilizer_quantity: float = 0):
        super().__init__(
            emoji='🎋',
            product=Product.WILLOW_WOOD,
            water_needs=8.5,
            growth_rate=3.5,
            size=10,
            fertilizer_limit=1.425,
            growth=growth, fertilizer_quantity=fertilizer_quantity
        )
