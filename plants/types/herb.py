...
class Herb(Plant):
    def __init__(self, *, water_needs: confloat(ge=0.5, le=2.5), growth_rate: confloat(gt=5, le=12),
                 size: conint(ge=1, le=3), fertilizer_limit: confloat(gt=0, le=0.8),
                 growth: float = 0, fertilizer_quantity: float = 0):
        super().__init__(water_needs=water_needs, growth_rate=growth_rate, size=size,
                         fertilizer_limit=fertilizer_limit, growth=growth, fertilizer_quantity=fertilizer_quantity)
